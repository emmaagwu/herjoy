  ...
  return (
    <div id="about" ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
      <div className="relative flex flex-col lg:flex-row gap-8 lg:gap-8 lg:items-end lg:justify-center lg:min-h-[691px] ">
        {/* Text Block */}
        <div
          className={`relative min-h-[550px] lg:w-[514px] lg:h-[688px] p-8 lg:p-16 lg:py-24 rounded-[40px] md:rounded-[60px]
        ...
        <div className="w-full lg:w-auto lg:flex-shrink-0">
          <div
            className={`overflow-hidden w-full h-auto lg:w-[514px] lg:h-[688px] transition-all duration-1200 ease-out rounded-[40px] md:rounded-[60px] delay-400 transform-gpu group ${
              isVisible
                ? 'opacity-100 translate-x-0 scale-100'
                : 'opacity-0 translate-x-12 scale-95'
            } hover:scale-102 hover:shadow-2xl hover:shadow-black/20`}            
          >
            <img
