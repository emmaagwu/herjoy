    ...
    <section id="testimonials" ref={sectionRef} className="py-16 px-4 max-w-7xl mx-auto">
      ...
      <div className={`flex justify-center mb-12 transition-all duration-800 ease-out delay-700 ${
        ...
        <a
          ...
          className="inline-block bg-[#A7C047] text-white px-8 py-3 rounded-full font-[Chopin] font-semibold text-[16px] md:text-[20px]  transition-all duration-300 ease-out hover:bg-[#8FA038] hover:scale-105 hover:shadow-lg hover:shadow-[#A7C047]/30 active:scale-95 transform-gpu relative overflow-hidden"
          ...
          >
            ...
            <div className="mb-6">
              <img
                ...
                className="w-full h-auto object-cover rounded-2xl transition-transform duration-700 ease-out group-hover:scale-105"
              />
